!function ($) {
    ...
    var Page = function (element, options) {
        ...
        var init = function (obj) {
            ...
            //init jump module
            var jumpHtml = '<div class="c-pagination-group"><span class="fl c-pagination-grouptext">\u8df3\u8f6c\u81f3</span><input type="text"><button data-page-btn="jump" type="button">' + that.options.jumpBtnText + '</button></div>';
    ...
    Page.prototype = {
        ...
        _updateTotal: function (total) {
			...
			this.$stat.html('<li><span>\u5171<em>'+this.pageCount+'</em>\u9875</span></li>');
        },
        destroy: function () {
